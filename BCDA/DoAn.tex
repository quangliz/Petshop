...
\ifPDFTeX
  ...
  \usepackage{times} % Chọn font Times New Roman cho pdfLaTeX
\else
  \usepackage{fontspec}
...
\usepackage{tabularx} % Tạo bảng tự chia đều bề rộng theo dòng
\usepackage{longtable} % Cho phép bảng dài tự ngắt qua trang
...
\newglossarystyle{pawsomeabbr}{%
  ...
  \renewcommand*{\subglossentry}[3]{%
    & \glssubentryitem{##2}\glossentrydesc{##2} \\
    \hline}%
}
\setglossarystyle{pawsomeabbr}
\usepackage{setspace}
\usepackage{parskip}
...
\renewcommand{\bibname}{Danh sách tài liệu tham khảo} 
...
\graphicspath{{\subfix{./}}} % Thư mục chứa các hình ảnh, dùng \subfix để chạy được cả khi biên dịch file con
...
\titlecontents{chapter}
    ...
    {}         % unnumbered format
    {\titlerule*[0.3pc]{.}\contentspage}         % filler-page-format, e.g dots
\chapter{HƯỚNG DẪN CÀI ĐẶT, TRIỂN KHAI VÀ KIỂM THỬ}
