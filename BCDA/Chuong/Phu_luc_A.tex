...
Frontend mặc định chạy tại \texttt{http://localhost:3000}. Khi kiểm tra giao diện, nên chạy cả backend, frontend, database, Redis và seed dữ liệu sản phẩm/knowledge đủ đại diện.
