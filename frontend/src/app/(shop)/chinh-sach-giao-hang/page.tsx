  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        { title: "Sự cố giao nhận", paragraphs: ["Khi kiện hàng hư hỏng, thiếu hàng hoặc giao sai, khách hàng nên chụp ảnh và liên hệ qcontact.12@gmail.com sớm nhất để được kiểm tra."] },
      ]}
    />
  );
}
