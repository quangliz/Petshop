  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        { title: "Sự cố giao nhận", paragraphs: ["Khi kiện hàng hư hỏng, thiếu hàng hoặc giao sai, khách hàng nên chụp ảnh và liên hệ help@thepawsome.store sớm nhất để được kiểm tra."] },
      ]}
    />
  );
}
