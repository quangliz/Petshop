  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        { title: "Cách yêu cầu", paragraphs: ["Gửi mã đơn, lý do và hình ảnh tới qcontact.12@gmail.com. Nhân viên sẽ xác minh trước khi hướng dẫn gửi hàng hoặc hoàn tiền."] },
      ]}
    />
  );
}
