  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        { title: "Cách yêu cầu", paragraphs: ["Gửi mã đơn, lý do và hình ảnh tới support@thepawsome.store. Nhân viên sẽ xác minh trước khi hướng dẫn gửi hàng hoặc hoàn tiền."] },
      ]}
    />
  );
}
