      ...
      <div className="bg-white/95 border border-neutral-100 rounded-[20px] shadow-lg w-full max-w-[460px] mx-auto p-7 sm:p-9 md:p-10">
        {isRegistered ? (
          <div className="text-center py-4">
            <div className="w-16 h-16 rounded-[20px] flex items-center justify-center text-white mx-auto mb-6 bg-primary-600 shadow-[0_8px_16px_var(--primary-100)]">
              <Mail size={32} />
            </div>
            <h1 className="text-[24px] font-extrabold tracking-[-0.02em] mb-3">Kiểm tra email</h1>
            <p className="text-[14px] text-neutral-500 mb-6 leading-relaxed">
              Chúng tôi đã gửi một liên kết kích hoạt đến email <strong className="text-neutral-800">{registeredEmail}</strong>. Vui lòng nhấp vào liên kết trong email để kích hoạt tài khoản của bạn.
            </p>
            <p className="text-[13px] text-neutral-400 mb-8">
              (Nếu không tìm thấy email, vui lòng kiểm tra cả thư mục Spam hoặc Thư rác)
            </p>
            <Link
              href="/login"
              className="w-full h-[52px] rounded-[14px] text-[15px] font-semibold text-white flex items-center justify-center gap-2 hover:opacity-90 transition-opacity no-underline animate-pulse"
