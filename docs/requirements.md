...
| NFR-06 | Reliability | Docker healthcheck cho backend/frontend; `/health` cho backend |
...
| FR-13 | `POST /orders/checkout` | `/checkout`, `/orders` | `tests/test_orders.py` |
| FR-14, FR-16 | `POST /orders/guest-checkout`, `GET /orders/guest-lookup` | `/checkout`, `/tra-cuu-don-hang` | `tests/test_orders.py` |
| FR-15, FR-17 | `GET /orders`, `GET /orders/{order_id}`, `PUT /orders/{order_id}/cancel` | `/orders`, `/orders/[id]` | `tests/test_orders.py` |
| FR-18, FR-19 | `POST /payments/vnpay/create/{order_id}`, `GET /payments/vnpay/ipn` | `/orders/payment/callback` | `tests/test_payments.py`, `test_payments_proxy.py` |
